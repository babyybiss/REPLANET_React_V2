    ...
    return (
        campaign && (
            <div className="item mt-2 mb-2">
                ...
                <div dangerouslySetInnerHTML={{ __html: campaign.campaignContent }} className="card mt-2 mb-2" style={{ marginTop:"30px" ,padding:"10px",  minHeight:"300px", width:"100%", height:"100%"}}>
                </div>
            </div>
        )
    );
