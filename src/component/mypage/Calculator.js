    ...
    return(
        ...
        <div className="admin-main">
            <div>
                ...
                <div>
                    <h6>
                        1. 기부금 중 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>법정기부금</span>에 한해서만 계산을 하실 수 있도록 만들어진 계산기입니다. 
                    </h6>
                    <h6>
                        &nbsp;&nbsp;&nbsp;(정치자금 기부금, 우리사주조합 기부금, 지정 기부금 계산 불가)
                    </h6>
                </div>
                <div>
                    <h6>
                        2. <span className="pay-color-green" style={{ fontWeight: 'bold' }}>세액공제율</span> 같은 경우 한시적으로 변경이 될 수 있습니다.
                    </h6>
                </div>
                <div>
                    <h6>
                        3. <span className="pay-color-green" style={{ fontWeight: 'bold' }}>기부금 세액공제</span>는 기부자가 근로자 본인이거나 배우자, 직계존속(부모님, 조부모, 외조부모 등), 직계비속(자녀, 손자‧손녀, 외손자‧외손녀 등) 등의 기본공제 대상자(나이 요건 제한 없음, 소득 요건 제한 있음)인 경우에만 혜택을 제공받을 수 있습니다.
                    </h6>
                </div>
                <br/>
                <div>
                ...
                <div>
                    <h6>
                        1. 국세청에서는 ‘특별재해(재난)지역’의 복구를 위한 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>자원봉사</span> 시간을 금품으로 환산해 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>기부금 세액공제</span> 혜택을 제공하고 있습니다. 특별재해(재난)지역으로 선포된 이후 뿐 아니라 선포되기 이전에 했던 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>자원봉사</span>에도 동일하게 적용합니다.
                    </h6>
                </div>
                <div>
                    <h6>
                        2. 자원봉사 후 해당 지역의 지방자치단체장 혹은 지방자치단체장의 위임을 받은 단체의 장이나 자원봉사센터장으로부터 ‘특별재해(재난)지역 자원봉사용역 등에 대한 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>기부금 확인서</span>를 발급받아야 합니다.
                    </h6>
                </div>
                <div>
                    <h6>
                        3. 이 같은 자원봉사용역은 <span className="pay-color-green" style={{ fontWeight: 'bold' }}>법정기부금과 같은 조건</span>으로 공제되는데요. 자원봉사 8시간을 1일로 환산해 봉사일수에 5만원을 곱한 금액을 공제해주고 있습니다.
                    </h6>
                </div>
                <br/>
                <div>
                ...
                <div>
                    <h6>
                        <a href="https://finsupport.naver.com/contentsGuide/264">2023년 달라진 《기부금 세액공제》 (링크)</a>
                    </h6>
                    <h6>
                        <a href="https://finsupport.naver.com/contentsGuide/119">가족 대상으로 받을 수 있는 소득‧세액공제 총정리 해드립니다 (링크)</a>
                    </h6>
                </div>
            </div>
        </div>
